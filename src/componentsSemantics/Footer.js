...
const Footer = () => {
    return(
        <div className="footer">
         ...
         <a className='footer-link' href="" target="_blank"> <i class="github icon"> GitHub</i></a>
        ...
        <a className='footer-link' href="#" target="_blank"><i class="stack overflow icon">Stack Overflow</i></a> 

        <a className='footer-link' href="twitter.com" target="_blank"><i class="twitter icon">Twitter</i></a>
        </div>
    )
};
